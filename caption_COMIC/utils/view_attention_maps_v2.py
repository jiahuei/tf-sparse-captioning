...
eval_root = '/home/jiahuei/Documents/1_TF_files/caption_baseN/mscoco_v6/v6_0_cocoV1_icpV1_lstm_word_c2c_b32_h1_tied_r512_w256_run_01/infer_test_beam_3_lpen_0.0'
...
with open(pjoin(eval_root, 'outputs___79679.pkl'), 'rb') as f:
    outputs = pickle.load(f)

with open(pjoin(eval_root, 'metric_scores_detailed_79679.json'), 'r') as f:
    scores = json.load(f)
