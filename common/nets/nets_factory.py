...
# ==============================================================================
"""
last checked against official repo on 06 Apr 2020 (cb84518).
...
from common.nets import alexnet
from common.nets import cifarnet
from common.nets import i3d
from common.nets import inception
from common.nets import lenet
from common.nets import mobilenet_v1
from common.nets import masked_mobilenet_v1
from common.nets import overfeat
from common.nets import resnet_v1
from common.nets import resnet_v2
from common.nets import s3dg
from common.nets import vgg
from common.nets.mobilenet import mobilenet_v2
from common.nets.mobilenet import mobilenet_v3
from common.nets.nasnet import nasnet
from common.nets.nasnet import pnasnet
#from common.nets.keras_squeezenet import squeezenet
...
networks_map = {'alexnet_v2': alexnet.alexnet_v2,
                ...
                # 'squeezenet': squeezenet.squeezenet_v1_1,
                'masked_inception_v1': inception.masked_inception_v1,
                'masked_mobilenet_v1': masked_mobilenet_v1.masked_mobilenet_v1,
                'masked_mobilenet_v1_075': masked_mobilenet_v1.masked_mobilenet_v1_075,
                'masked_mobilenet_v1_050': masked_mobilenet_v1.masked_mobilenet_v1_050,
                'masked_mobilenet_v1_025': masked_mobilenet_v1.masked_mobilenet_v1_025,
                }
...
arg_scopes_map = {'alexnet_v2': alexnet.alexnet_v2_arg_scope,
                  ...
                  # 'squeezenet': mobilenet_v1.mobilenet_v1_arg_scope,
                  'masked_inception_v1': inception.masked_inception_arg_scope,
                  'masked_mobilenet_v1': masked_mobilenet_v1.masked_mobilenet_v1_arg_scope,
                  'masked_mobilenet_v1_075': masked_mobilenet_v1.masked_mobilenet_v1_arg_scope,
                  'masked_mobilenet_v1_050': masked_mobilenet_v1.masked_mobilenet_v1_arg_scope,
                  'masked_mobilenet_v1_025': masked_mobilenet_v1.masked_mobilenet_v1_arg_scope,
                  }
