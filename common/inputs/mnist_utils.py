"""
https://github.com/namhoonlee/snip-public/blob/f0284968bfa9b17d335587183b1c84cf628efe84/snip/mnist.py
"""
import gzip
import os
import numpy as np
...
# a = read_data('/home/jiahuei/Documents/3_Datasets/MNIST')
# b = zip(a['train']['input'], a['train']['label'])